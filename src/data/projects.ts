...
export const projects: Project[] = [
  ...
  // },
  {
    title: "Distributed KV Store with Custom Skip List MemTable",
    desc: "Dynamo-style KV store with skip list MemTable, vector clocks, gossip failure detection, and crash-safe quorum writes.",
    tags: ["Python", "Docker", "Nginx", "Prometheus", "Grafana"],
  ...
  {
    title: "KNotify",
    desc: "Kafka-based notification pipeline with idempotent consumers, adaptive batching, and full Prometheus/Grafana observability.",
    tags: ["Python", "Docker", "Kafka", "Prometheus", "Grafana", "PostgreSQL"],
